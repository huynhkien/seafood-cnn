...
const Page = () => {
  ...
  const fetchProductsByName = async (queries) => {
    const response = await apiGetProducts({ name: search, ...queries });
            ...
            <div className="row">
              <div className="col-xl-2 col-lg-12 col-md-12">
                <div className="tpshop__leftbar shadow">
                  ...
                  <div className="tpshop__widget">
                    <h5 className="tpshop__widget-title mb-2">Lọc theo giá</h5>
                    <InputSearch
                      name="Giá"
              ...
              <div className="col-xl-10 col-lg-12 col-md-12">
                <div className="tpshop__top ml-60">
                  <div className="row row-cols-xxl-4 row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-sm-2 row-cols tpproduct__shop-item">
                    {products?.setData?.map((el) => (
                      <div className="col product-col mb-4" key={el._id}>
                        <Product
                          productData={{
                            thumb: el?.thumb?.url,
